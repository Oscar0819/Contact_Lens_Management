...
class EveryDayWorker(appContext: Context, workerParams: WorkerParameters):
    ...
    companion object {
        const val TAG = "EveryDayWorker"

        private const val D_CHANNEL_ID: String = "Expiration Date Notification Channel"
        private const val D_CHANNEL_NAME: String = "Expiration Date Notification Channel"
    }
